...
function TranscribingOverlay() {
 ...
 <motion.div
 className="absolute inset-0 h-8 w-8 animate-pulse bg-primary/20"
...
function RecordingPrompt({ isVisible, onStopRecording }: RecordingPromptProps) {
 ...
 className="absolute left-1/2 flex -translate-x-1/2 cursor-pointer overflow-hidden whitespace-nowrap border bg-background py-1 text-center text-sm text-muted-foreground"
