...
const ImageFilePreview = React.forwardRef<HTMLDivElement, FilePreviewProps>(
 ...
 <motion.div
 ref={ref}
 className="relative flex max-w-[200px] border p-1.5 pr-2 text-xs"
 layout
 ...
 className="grid h-10 w-10 shrink-0 place-items-center border bg-muted object-cover"
 ...
 {onRemove ? (
 <button
 className="absolute -right-2 -top-2 flex h-4 w-4 items-center justify-center border bg-background"
 type="button"
 onClick={onRemove}
...
const TextFilePreview = React.forwardRef<HTMLDivElement, FilePreviewProps>(
 ...
 >
 <div className="flex w-full items-center space-x-2">
 <div className="grid h-10 w-10 shrink-0 place-items-center border bg-muted p-0.5">
...
const GenericFilePreview = React.forwardRef<HTMLDivElement, FilePreviewProps>(
 ...
 >
 <div className="flex w-full items-center space-x-2">
 <div className="grid h-10 w-10 shrink-0 place-items-center border bg-muted">
